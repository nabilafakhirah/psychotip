...
public class PsychologistHomeFragmentInstrumentedTest {

    /*@Rule
    public IntentsTestRule<PsychologistHomeFragment> activityRule
            = new IntentsTestRule<>(PsychologistHomeFragment.class);

    @Test
    public void testNameText() {
        onView(withId(R.id.psychologist_name)).check(matches(notNullValue()));
    }
